...
test = pd.read_excel("DTL_Sample_Tests.xlsx", sheet_name ="Test"+str(whichTest))
marks = pd.read_excel("DTL_Sample_Marks.xlsx", sheet_name ="Test"+str(whichTest), index_col = "Student_ID")
...
question_bank = pd.ExcelFile("DTL_Knowledge_Graph_Test.xlsx")
...
for i in test.iterrows():
    ...
    KG = nx.read_graphml("KG.graphml") #Contains the KG
